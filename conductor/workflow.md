...
> Note: Replace placeholder examples below with concrete project commands as soon as scaffolding is complete.
...
Use these endpoints to inspect and validate backend API contracts during local workflows:
